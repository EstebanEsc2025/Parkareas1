...
Agenda2Button.addEventListener("click", (e) => {
    e.preventDefault();
    location.href = "/views/User/Agenda2/Agenda2.html";
  });

  Agenda2Button2.addEventListener("click", (e) => {
    e.preventDefault();
    location.href = "/views/User/Agenda2/Agenda2.html";
  });

  Agenda2Button3.addEventListener("click", (e) => {
    e.preventDefault();
    location.href = "/views/User/Agenda2/Agenda2.html";
  });